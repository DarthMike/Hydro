...
inline void IND_Render::CalculeFrustumPlanes	()
{
	...
	mInfo.mDevice->GetTransform (D3DTS_VIEW, &mMatView);
	mInfo.mDevice->GetTransform (D3DTS_PROJECTION, &mMatProj);
...
==================
*/
WORD IND_Render::CullFrustumBox (const D3DXVECTOR3 &pAABBMin, const D3DXVECTOR3 &pAABBMax)
{
	bool mIntersect = 0;
	WORD mResult = 0;
...
==================
*/
void IND_Render::CalculateBoundingRectangle (D3DXVECTOR3 *mP1, D3DXVECTOR3 *mP2, D3DXVECTOR3 *mP3, D3DXVECTOR3 *mP4)
{
