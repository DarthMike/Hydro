													 ...
													 BOUNDING_COLLISION *pB2, IND_Matrix pMat2, float pScale2)
{
	...
	// Circle 1
	D3DXVECTOR2 mCenter1 ((float) pB1->mPosX, (float) pB1->mPosY);			
	int mRadius1 = (int) (pB1->mRadius * pScale1);

	// Circle 1
	D3DXVECTOR2 mCenter2 ((float) pB2->mPosX, (float) pB2->mPosY);			
													   ...
													   BOUNDING_COLLISION *pB2, IND_Matrix pMat2)
{
	...
	// Triangle 1
	D3DXVECTOR2 mA1 ((float) pB1->mAx, (float) pB1->mAy);			
	D3DXVECTOR2 mB1 ((float) pB1->mBx, (float) pB1->mBy);	
	D3DXVECTOR2 mC1 ((float) pB1->mCx, (float) pB1->mCy);

	// Triangle 2
	D3DXVECTOR2 mA2 ((float) pB2->mAx, (float) pB2->mAy);			
	D3DXVECTOR2 mB2 ((float) pB2->mBx, (float) pB2->mBy);	
	D3DXVECTOR2 mC2 ((float) pB2->mCx, (float) pB2->mCy);
														...
														BOUNDING_COLLISION *pB2, IND_Matrix pMat2)
{
	...
	// Circle 1
	D3DXVECTOR2 mCenter ((float) pB1->mPosX, (float) pB1->mPosY);			
	...
	// Triangle
	D3DXVECTOR2 mA ((float) pB2->mAx, (float) pB2->mAy);			
	D3DXVECTOR2 mB ((float) pB2->mBx, (float) pB2->mBy);	
	D3DXVECTOR2 mC ((float) pB2->mCx, (float) pB2->mCy);

	// Transformations
	D3DXVECTOR4 mAt, mBt, mCt;

	D3DXVec2Transform (&mAt, &mA, &mMat2);
	D3DXVec2Transform (&mBt, &mB, &mMat2);
...
==================
*/
inline bool IND_Render::IsTriangleToTriangleCollision	(D3DXVECTOR2 a1, 
														D3DXVECTOR2 b1,
														D3DXVECTOR2 c1,
														D3DXVECTOR2 a2,
														D3DXVECTOR2 b2,
...
==================
*/
inline bool IND_Render::IsCircleToCircleCollision		(D3DXVECTOR2 pP1, int pRadius1,
...
==================
*/
inline bool IND_Render::IsCircleToTriangleCollision		(D3DXVECTOR2 pPCenter, int pRadius, 
...
==================
*/
inline bool IND_Render::IsSegmentIntersection	(D3DXVECTOR2 a, 
												D3DXVECTOR2 b, 
												D3DXVECTOR2 c, 
												D3DXVECTOR2 d)
{
