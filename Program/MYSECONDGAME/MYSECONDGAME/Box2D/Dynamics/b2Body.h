...
struct b2BodyDef
{
	...
	/// MIGUEL MODIFICATION: Position correction disabling
	bool applyPosCorrection;
};
...
public:
	...
	//MIGUEL MODIFICATION: CHANGES MADE TO BOX2D: ACCESS TO LINEAR AND ANGULAR DAMPING VALUES
	float32 GetAngularDamping() {return m_angularDamping; }
	float32 GetLinearDamping() {return m_linearDamping; }

	//MIGUEL MODIFICATION: Position correction disabling
	bool IsPosCorrectionEnabled();
private:
	...
	enum
	{
		...
		e_posCorrectionFlag = 0x0080  // MIGUEL MODIFICATION: Position correction disabling
	};
...
//MIGUEL MODIFICATION: Position Correction disabling
inline bool b2Body::IsPosCorrectionEnabled()
{
	return ((m_flags & e_posCorrectionFlag) == e_posCorrectionFlag);
}
#endif
