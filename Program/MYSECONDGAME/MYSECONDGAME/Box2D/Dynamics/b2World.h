...
public:
	...
	//MIGUEL MODIFICATION: RESET FORCES TRIGGERING
	void Step(float32 timeStep, int32 velocityIterations, int32 positionIterations, bool resetForces);
	...
	/// MIGUEL MODIFICATION: Draw DEBUG info in screen - CHANGED TO MAKE IT DIRECLY
	void DrawDebugData();
private:
